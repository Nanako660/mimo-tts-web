...
module.exports = {
  ...
  prompt: {
    ...
    scopes: [
      { value: 'ui', name: 'ui:        用户界面/交互体验相关' },
      { value: 'tts', name: 'tts:       语音合成核心逻辑' },
      { value: 'audio', name: 'audio:     音频播放/录音/处理' },
      { value: 'clone', name: 'clone:     声音复刻/音色设计' },
      { value: 'batch', name: 'batch:     批量生成中心' },
      { value: 'api', name: 'api:       API 接口与网络请求' },
      { value: 'storage', name: 'storage:   本地存储/IndexedDB/历史记录' },
      { value: 'release', name: 'release:   版本发布与构建相关' },
      { value: 'deps', name: 'deps:      依赖更新与管理' },
    ],
    useEmoji: true,
    emojiAlign: 'center',
    themeColorCode: '',
    ...
    breaklineChar: '|',
    skipQuestions: [],
    issuePrefixes: [{ value: 'closed', name: 'closed:   关闭对应 ISSUE' }],
    customIssuePrefixAlign: 'top',
    emptyIssuePrefixAlias: 'skip',
    customIssuePrefixAlias: 'custom',
    allowCustomIssuePrefix: true,
    allowEmptyIssuePrefix: true,
    confirmColorActive: '\x1b[32m',
    confirmColorDisabled: '\x1b[33m',
  },
};
